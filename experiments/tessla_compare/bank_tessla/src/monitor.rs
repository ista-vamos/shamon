...
pub struct State<
    E,
Fbalancemismatch, BFbalancemismatch, Fbalancenegative, BFbalancenegative
> where
Fbalancemismatch: (FnMut(TesslaValue<(TesslaInt, TesslaInt, TesslaInt,)>, i64) -> Result<(), E>) + ?Sized,
BFbalancemismatch: BorrowMut<Fbalancemismatch>,
Fbalancenegative: (FnMut(TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>, i64) -> Result<(), E>) + ?Sized,
...
var_balancehistory_1222_: EventContainer<TesslaMap<TesslaInt, TesslaValue<(TesslaInt, TesslaInt,)>>>,
var_1225_: EventContainer<TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>>,
var_1229_: EventContainer<TesslaValue<Rc<dyn Fn(TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>, TesslaInt, TesslaValue<(TesslaInt, TesslaInt,)>) -> TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>>>>,
var_1228_: EventContainer<TesslaValue<Rc<dyn Fn(TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>, TesslaInt, TesslaValue<(TesslaInt, TesslaInt,)>) -> TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>>>>,
...
var_monwithdraw: EventContainer<TesslaValue<(TesslaInt, TesslaInt, TesslaBool,)>>,
var_montransfer: EventContainer<TesslaValue<(TesslaInt, TesslaInt, TesslaInt, TesslaBool,)>>,
var_reset: EventContainer<TesslaUnit>,
var_monbalance: EventContainer<TesslaValue<(TesslaInt, TesslaInt,)>>,
var_deposit: EventContainer<TesslaValue<(TesslaInt, TesslaInt,)>>
}

fn var_getOrElse_1204_<K_525_: 'static + Eq + Hash + Clone, V_526_: 'static + Clone>(var_map_1344_: TesslaMap<TesslaValue<K_525_>, TesslaValue<V_526_>>, var_key_1345_: TesslaValue<K_525_>, var_default_1346_: TesslaValue<V_526_>) -> TesslaValue<V_526_> {
...
fn var_1224__1360_(var_lbmp_1351_: TesslaOption<TesslaMap<TesslaInt, TesslaInt>>) -> TesslaValue<Rc<dyn Fn(TesslaInt, TesslaInt) -> TesslaValue<(TesslaInt, TesslaValue<(TesslaInt, TesslaInt,)>,)>>> {
return Value(Rc::new(move |var_acc_1361_: TesslaInt, var_bal_1362_: TesslaInt| {
let var___2_1365_ = var_getOrElse_1204_(var_lbmp_1351_.clone().get_some(), var_acc_1361_.clone(), var_bal_1362_.clone());
...
fn var_isSome_1201_<T_369_: 'static + Clone>(var_opt_1341_: TesslaOption<TesslaValue<T_369_>>) -> TesslaBool {
let var_1342_ = !(var_opt_1341_.clone().is_none());
return var_1342_.clone();
}
fn var_1192__1288_(var_dep_1262_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>) -> TesslaValue<Rc<dyn Fn(TesslaInt, TesslaInt) -> TesslaValue<(TesslaInt, TesslaInt,)>>> {
return Value(Rc::new(move |var_acc_1312_: TesslaInt, var_bal_1313_: TesslaInt| {
...
fn var_1192__1324_(var_wdrw_1263_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt, TesslaBool,)>>) -> TesslaValue<Rc<dyn Fn(TesslaInt, TesslaInt) -> TesslaValue<(TesslaInt, TesslaInt,)>>> {
return Value(Rc::new(move |var_acc_1330_: TesslaInt, var_bal_1331_: TesslaInt| {
...
fn var_1192__1286_(var_wdrw_1263_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt, TesslaBool,)>>, var_dep_1262_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>) -> TesslaValue<Rc<dyn Fn(TesslaInt, TesslaInt) -> TesslaValue<(TesslaInt, TesslaInt,)>>> {
return Value(Rc::new(move |var_acc_1293_: TesslaInt, var_bal_1294_: TesslaInt| {
...
fn var_1192_(var_dep_1262_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>, var_wdrw_1263_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt, TesslaBool,)>>, var_blnc_1264_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>, var_rst_1265_: TesslaOption<TesslaUnit>, var_bmp_1266_: TesslaOption<TesslaMap<TesslaInt, TesslaInt>>) -> TesslaOption<TesslaMap<TesslaInt, TesslaInt>> {
...
fn var_1189_(var_dep_1247_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt, TesslaBool,)>>, var_trnsfr_1248_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt, TesslaInt, TesslaBool,)>>) -> TesslaOption<TesslaValue<(TesslaInt, TesslaInt, TesslaBool,)>> {
...
fn var_1182_(var_bal_1193_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>, var_bmp_1194_: TesslaOption<TesslaMap<TesslaInt, TesslaInt>>) -> TesslaOption<TesslaValue<(TesslaInt, TesslaInt, TesslaInt,)>> {
let var_1220_ = Lazy::new(|| var_bal_1193_.clone().get_some());
let var_1205_ = Lazy::new(|| var_bmp_1194_.clone().get_some());
let var_1213_ = Lazy::new(|| match var_1220_.clone() { Value(value) => value.0, Error(error) => Error(error) });
let var_1215_ = Lazy::new(|| match var_1220_.clone() { Value(value) => value.1, Error(error) => Error(error) });
...
fn var_1230_(var_acc_1367_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>, var_k_1368_: TesslaInt, var_v_1369_: TesslaValue<(TesslaInt, TesslaInt,)>) -> TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>> {
let var_1374_ = Lazy::new(|| match var_v_1369_.clone() { Value(value) => value.0, Error(error) => Error(error) });
...
fn var_1187_(var_dep_1231_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>, var_trnsfr_1232_: TesslaOption<TesslaValue<(TesslaInt, TesslaInt, TesslaInt, TesslaBool,)>>) -> TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>> {
...
fn var_1224_(var_bmp_1350_: TesslaOption<TesslaMap<TesslaInt, TesslaInt>>, var_lbmp_1351_: TesslaOption<TesslaMap<TesslaInt, TesslaInt>>) -> TesslaOption<TesslaMap<TesslaInt, TesslaValue<(TesslaInt, TesslaInt,)>>> {
...
var_monwithdraw: init(),
var_montransfer: init(),
var_reset: init(),
var_monbalance: init(),
var_deposit: init()
        }
...
pub fn set_monwithdraw(&mut self, value: TesslaValue<(TesslaInt, TesslaInt, TesslaBool,)>) {
self.var_monwithdraw.set_event(value);
}

pub fn set_montransfer(&mut self, value: TesslaValue<(TesslaInt, TesslaInt, TesslaInt, TesslaBool,)>) {
self.var_montransfer.set_event(value);
}
...
pub fn set_monbalance(&mut self, value: TesslaValue<(TesslaInt, TesslaInt,)>) {
self.var_monbalance.set_event(value);
}
...
constant(&mut self.var_1176_, Value(()), &self.var_monwithdraw);
constant(&mut self.var_1178_, Value(()), &self.var_monbalance);
constant(&mut self.var_1180_, Value(()), &self.var_montransfer);
merge(&mut self.var_any_1173_, vec![&self.var_1174_, &self.var_1176_, &self.var_1178_, &self.var_1180_, &self.var_reset]);
last(&mut self.var_1223_, &self.var_balances_1172_, &self.var_any_1173_);
lift2(&mut self.var_balancemismatch_1170_, &self.var_monbalance, &self.var_1223_, TesslaValue::wrap(var_1182_ as fn(_, _) -> _));
self.var_balancemismatch_1170_.call_output(self.out_balancemismatch.borrow_mut(), self.current_ts)?;
lift2(&mut self.var_adjdeposit_1186_, &self.var_deposit, &self.var_montransfer, TesslaValue::wrap(var_1187_ as fn(_, _) -> _));
lift2(&mut self.var_adjwithdraw_1188_, &self.var_monwithdraw, &self.var_montransfer, TesslaValue::wrap(var_1189_ as fn(_, _) -> _));
last(&mut self.var_1190_, &self.var_1191_, &self.var_any_1173_);
lift5(&mut self.var_balances_1172_, &self.var_adjdeposit_1186_, &self.var_adjwithdraw_1188_, &self.var_monbalance, &self.var_reset, &self.var_1190_, TesslaValue::wrap(var_1192_ as fn(_, _, _, _, _) -> _));
lift2(&mut self.var_balancehistory_1222_, &self.var_balances_1172_, &self.var_1223_, TesslaValue::wrap(var_1224_ as fn(_, _) -> _));
default(&mut self.var_1225_, &self.var_1226_);
default(&mut self.var_1228_, &self.var_1229_);
slift3(&mut self.var_balancenegativeOpt_1184_, &self.var_balancehistory_1222_, &self.var_1225_, &self.var_1228_, TesslaValue::wrap((|tLPar_0: TesslaMap<TesslaInt, TesslaValue<(TesslaInt, TesslaInt,)>>, tLPar_1: TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>, tLPar_2: TesslaValue<Rc<dyn Fn(TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>, TesslaInt, TesslaValue<(TesslaInt, TesslaInt,)>) -> TesslaOption<TesslaValue<(TesslaInt, TesslaInt,)>>>>|{ return tLPar_0.fold(tLPar_1,tLPar_2) }) as fn(_, _, _) -> _));
slift1(&mut self.var_1185_, &self.var_balancenegativeOpt_1184_, TesslaValue::wrap(var_isSome_1201_ as fn(_) -> _));
filter(&mut self.var_balancenegative_1183_, &self.var_balancenegativeOpt_1184_, &self.var_1185_);
self.var_balancenegative_1183_.call_output(self.out_balancenegative.borrow_mut(), self.current_ts)?;
...
self.var_monwithdraw.update_last();
self.var_montransfer.update_last();
self.var_reset.update_last();
self.var_monbalance.update_last();
