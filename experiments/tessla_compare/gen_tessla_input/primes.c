...
size_t i1, i2;
	...
	count = shm_arbiter_buffer_peek(BUFFER_P0, 10, (void**)&e1, &i1, (void**)&e2, &i2);
	print_buffer_prefix(BUFFER_P0, 0, i1 + i2, count, e1, i1, e2, i2);
	fprintf(stderr, "Prefix of 'P1':\n");
	count = shm_arbiter_buffer_peek(BUFFER_P1, 10, (void**)&e1, &i1, (void**)&e2, &i2);
...
stream_args_P_1 = malloc(sizeof(STREAM_Primes_ARGS));
	...
	BUFFER_P0 = shm_arbiter_buffer_create(EV_SOURCE_P_0,  sizeof(STREAM_Primes_out), 40000);
	...
	BUFFER_P1 = shm_arbiter_buffer_create(EV_SOURCE_P_1,  sizeof(STREAM_Primes_out), 40000);
	...
	shm_arbiter_buffer_set_active(BUFFER_P1, true);
 	...
 	monitor_buffer = shm_monitor_buffer_create(sizeof(STREAM_NumberPairs_out), 40000);
