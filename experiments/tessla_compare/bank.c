...
struct _STREAM_BankOutputEvent_in {
    shm_event head;
    union {
        EVENT_withdrawFail withdrawFail;EVENT_withdrawSuccess withdrawSuccess;EVENT_transferSuccess transferSuccess;EVENT_transfer transfer;EVENT_depositTo depositTo;EVENT_numOut numOut;EVENT_selectedAccount selectedAccount;EVENT_depositSuccess depositSuccess;EVENT_depositFail depositFail;EVENT_logout logout;EVENT_withdraw withdraw;EVENT_balance balance;
    }cases;
};
...
struct _STREAM_BankEvent_in {
    shm_event head;
    union {
        EVENT_SawBalance SawBalance;EVENT_SawWithdrawFail SawWithdrawFail;EVENT_SawWithdraw SawWithdraw;EVENT_Clear Clear;EVENT_SawDeposit SawDeposit;EVENT_SawTransferFail SawTransferFail;EVENT_SawTransfer SawTransfer;
    }cases;
};
...
uint64_t t = event_for_t->cases.logout.timestamp;
            ...
            if(true ) {
                ...
                vamos_assert(0 && "Should not happen"); 
...
int amnt = event_for_amnt->cases.numIn.num;
    ...
    arbiter_outevent->head.id = (*arbiter_counter)++;
    ((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawTransfer.from_ = from_;
((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawTransfer.to_ = to_;
((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawTransfer.amount = amnt;
...
int amnt = event_for_amnt->cases.numIn.num;
    ...
    arbiter_outevent->head.id = (*arbiter_counter)++;
    ((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawTransferFail.from_ = from_;
((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawTransferFail.to_ = to_;
((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawTransferFail.amount = amnt;
...
int action = event_for_action->cases.numIn.num;
    ...
    arbiter_outevent->head.id = (*arbiter_counter)++;
    ((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawBalance.account = acc;
((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawBalance.balance = amnt;
...
int amnt = event_for_amnt->cases.numIn.num;
    ...
    arbiter_outevent->head.id = (*arbiter_counter)++;
    ((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawDeposit.account = acc;
((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawDeposit.amount = amnt;
...
int amnt = event_for_amnt->cases.numIn.num;
    ...
    arbiter_outevent->head.id = (*arbiter_counter)++;
    ((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawWithdraw.account = acc;
((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawWithdraw.amount = amnt;
...
int amnt = event_for_amnt->cases.numIn.num;
    ...
    arbiter_outevent->head.id = (*arbiter_counter)++;
    ((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawWithdrawFail.account = acc;
((STREAM_BankEvent_out *) arbiter_outevent)->cases.SawWithdrawFail.amount = amnt;
...
current_rule_set = SWITCH_TO_RULE_SET_aligning;
	...
	shm_arbiter_buffer_drop(BUFFER_In, 1);
            ...
            int TEMPARR54[] = {BANKOUTPUTEVENT_WITHDRAW,BANKOUTPUTEVENT_WITHDRAWFAIL};
int TEMPARR55[] = {BANKINPUTEVENT_NUMIN,BANKINPUTEVENT_OTHERIN};
                ...
                if (are_events_in_head(e1_In, i1_In, e2_In, i2_In, 
                count_In, sizeof(STREAM_BankInputEvent_out), TEMPARR55, 2)) {
...
STREAM_BankInputEvent_out * event_for_t3 = (STREAM_BankInputEvent_out *) get_event_at_index(e1_In, i1_In, e2_In, i2_In, sizeof(STREAM_BankInputEvent_out), 1);
uint64_t t3 = event_for_t3->cases.otherIn.timestamp;
...
current_rule_set = SWITCH_TO_RULE_SET_aligning;
	...
	shm_arbiter_buffer_drop(BUFFER_In, 2);
            ...
            int TEMPARR56[] = {BANKOUTPUTEVENT_WITHDRAW,BANKOUTPUTEVENT_WITHDRAWSUCCESS};
int TEMPARR57[] = {BANKINPUTEVENT_NUMIN,BANKINPUTEVENT_OTHERIN};

            
                if (are_events_in_head(e1_Out, i1_Out, e2_Out, i2_Out, 
                count_Out, sizeof(STREAM_BankOutputEvent_out), TEMPARR56, 2)) {
                    
                if (are_events_in_head(e1_In, i1_In, e2_In, i2_In, 
                count_In, sizeof(STREAM_BankInputEvent_out), TEMPARR57, 2)) {
...
current_rule_set = SWITCH_TO_RULE_SET_aligning;
	...
	shm_arbiter_buffer_drop(BUFFER_In, 2);
            ...
            int TEMPARR58[] = {BANKOUTPUTEVENT_WITHDRAW,BANKOUTPUTEVENT_HOLE};

            
                if (are_events_in_head(e1_Out, i1_Out, e2_Out, i2_Out, 
                count_Out, sizeof(STREAM_BankOutputEvent_out), TEMPARR58, 2)) {
