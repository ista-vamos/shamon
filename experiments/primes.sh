...
PRIMES1_PID=$!
$DRIOPATH/build/bin64/drrun -root $DRIOPATH/build/ -c $SHAMONPATH/drsyscalls/libsyscalls.so -- $PRIMESPATH/primes 100000 >primes2out.txt&
PRIMES2_PID=$!
...
$SHAMONPATH/monitor Left:regex:/primes1 Right:regex:/primes1 > primesmonout.txt &
wait
