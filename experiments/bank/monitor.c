...
int main(int argc, char **argv) {
 ...
 init_intmap(&lower_bounds);
	...
	BUFFER_In = shm_arbiter_buffer_create(EV_SOURCE_In,  sizeof(STREAM_BankInputEvent_out), 16);
	...
	BUFFER_Out = shm_arbiter_buffer_create(EV_SOURCE_Out,  sizeof(STREAM_BankOutputEvent_out), 16);
