...
int n = event_for_n->cases.hole.n;
    ...
    if (are_events_in_head(BUFFER_Left, sizeof(STREAM_Primes_out), TEMPARR4, 1) && is_Right_done) {
        if(true ) {
...
STREAM_Primes_out * event_for_p = (STREAM_Primes_out *) get_event_at_index(e1_Left, i1_Left, e2_Left, i2_Left, sizeof(STREAM_Primes_out), 0);
int p = event_for_p->cases.Prime.p;
    ...
    if (are_events_in_head(BUFFER_Right, sizeof(STREAM_Primes_out), TEMPARR5, 1) && is_Left_done) {
        if(true ) {
...
STREAM_Primes_out * event_for_p = (STREAM_Primes_out *) get_event_at_index(e1_Right, i1_Right, e2_Right, i2_Right, sizeof(STREAM_Primes_out), 0);
int p = event_for_p->cases.Prime.p;
