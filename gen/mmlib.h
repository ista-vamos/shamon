...
static inline _mm_gco _mm_lib_string_concat(_mm_gco left, _mm_gco right)
{
  ...
  assert(((newlen > leftlen) && (newlen>rightlen)) && "Not enough space for new strings!");
...
static inline _mm_gco _mm_lib_substring(_mm_gco str, _mm_type_int start, _mm_type_int len)
{
